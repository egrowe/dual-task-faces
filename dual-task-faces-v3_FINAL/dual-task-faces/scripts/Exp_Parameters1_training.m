...
% % Ensure each type of trial is shown ONLY ONCE in a run of the experiment
% splitTrials = nTrials/stimTypes; %divide trial number by the total number of stimuli
% periphOrder = Shuffle(repmat([1:stimTypes],1,splitTrials)); %faces shown determined from these parameters
% 

%Get the stimulus pairs to be shown
newStimMatrix = ones(stimTypes, stimTypes)
...
for tr = 1 : nTrials
    ...
    TR(tr).periphOrder = cell2mat(shuffledStimPairings(tr));
...
%     
    ...
    imageHeightPeriph = 2 * Cfg.pixelsPerDegree;
    ...
    %%%%%%%%%%%%%%%%%%%%%%% PERIPHERAL LETTERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %Set female or male face selection determine by # in periphOrder for main peripheral task
